...
#    tell_parent: "Tell your Parent"
  ...
  common:
    back: "Regresar" # When used as an action verb, like "Navigate backward"
    continue: "Seguir" # When used as an action verb, like "Continue forward"
    loading: "Cargando..."
    saving: "Guardando..."
    sending: "Enviando..."
    send: "Enviar"
...
#    redo_shortcut: "(Ctrl+Shift+Z)"
  ...
  play_level:
    ...
    tip_control_destiny: "En el mundo de código abierto real, tienes el derecho de controlar tu propio destino. -Linus Trovalds"
    tip_no_code: "Ningún código es más rápido que no codificar. - Kelvin Henney"
    tip_code_never_lies: "El código nunca miente, los comentarios  a veces. — Ron Jeffries"
    tip_reusable_software: "Antes de que el software pueda ser reutilizado, primero debe poderse utilizar. - Rich Cook"
    tip_optimization_operator: "Todo lenguaje tiene un operador de optimizacion. En la mayoria de lenguajes ese operador es ‘//’"
    tip_lines_of_code: "Medir el progreso de programación por las líneas de código es como medir el progreso de construir  aviones por su peso. — Bill Gates"
    tip_source_code: "Quisiera cambiar el mundo, pero no me dan el código fuente."
    tip_javascript_java: "Java es a Javascript lo que Carro es a Alfombra. - Chris Heilmann"
    tip_move_forward: "Hagas lo que hagas, sigue avanzando. - Martin Luther King Jr."
    tip_google: "Tienes un problema y no puedes resolverlo? Googlealo!"
    tip_adding_evil: "Añadiendo una pizca de maldad."
    tip_hate_computers: "Eso es lo que pasa con las personas que creen odiar a las computadoras. Lo que realmente odian son a los pesimos programadores. - Larry Niven"
    tip_open_source_contribute: "Puedes ayudar a mejorar CodeCombat!"
